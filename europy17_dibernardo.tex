...
%--------------------------------------------------------------------
\begin{frame}
    \frametitle{Atom Probe Tomography (APT): a new playground for Big Data analysis}
        \begin{itemize}
...
\begin{columns}
    ...
    \begin{column}{0.45\textwidth}
        ...
        \end{textblock}
        \begin{textblock}{5}(2.2,1.95)
            \scriptsize\itshape{\textcolor{blue}{The MPG SuperComputer \textit{Hydra}\\ at the MPCDF}\\
                                                In total there are $~ 83.000$ cores\\ with a main memory of $280$ TB and a peak\\ 
...
\item \small visualize and process your \textbf{NumPy} arrays with any of the flagship VTK applications such as \textcolor{blue}{Mayavi, ParaView, VisIt\footnotemark, }
...
\end{enumerate}
\end{block}
\footnotetext[8]{\footnotesize MPCDF has no self-interests in any of the projects\\ nor any conflict of interest}
\end{frame}
% # **************************************************************
